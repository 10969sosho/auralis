    ...
    <div class="detail-refund-card" style="border-color:#fbbf24;background:#fffbeb;">
        ...
        <div class="detail-refund-body">
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                ...
                <a href="{{ $booking->payment->payment_meta['payment_url'] }}" class="detail-refund-btn" style="background:#1e40af;color:#fff;" data-translate-en="Open ToyibPay" data-translate-id="Buka ToyibPay">
