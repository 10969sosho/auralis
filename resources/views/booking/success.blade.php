...
<div class="success-page">
    <div class="success-hero">
        ...
        <h1 class="success-title" data-translate-en="Booking Confirmed!" data-translate-id="Pemesanan Dikonfirmasi!">Booking Confirmed!</h1>
        <p class="success-sub">Your booking <strong>#{{ $booking->booking_code }}</strong> has been confirmed.</p>
    </div>

    <div class="success-card">
        <h2 class="success-card-title" data-translate-en="Booking Details" data-translate-id="Detail Pemesanan">Booking Details</h2>
    ...
    <div class="success-card">
        <h2 class="success-card-title" data-translate-en="Your Tickets" data-translate-id="Tiket Anda">Your Tickets ({{ $booking->passengers->count() }})</h2>
